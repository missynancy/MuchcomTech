...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 glass-panel border-b border-slate-800/80 bg-[#0B0F17]/90 backdrop-blur-md">
      {/* Top Banner Notice */}
      <div className="bg-gradient-to-r from-cyan-950 via-slate-900 to-purple-950 px-4 py-1.5 text-xs text-slate-300 border-b border-cyan-500/20">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <span className="flex h-2 w-2 rounded-full bg-cyan-400 animate-ping"></span>
            <span className="font-medium text-cyan-300">Fast Dispatch Available</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2.5 group">
            <div className="p-2 rounded-xl bg-gradient-to-tr from-cyan-500 to-blue-600 shadow-glow-cyan transition-transform group-hover:scale-105">
